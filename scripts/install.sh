...
echo -e "    ◆ planner - Strategic planner (PLAN MODE)"
...
echo -e "    ● implementer - Code implementation (IMPLEMENT MODE)"
...
echo -e "    ○ validator - Validation stack (VALIDATE MODE)"
...
echo -e "  ${MAGENTA}◆ Opus:${NC}   orchestrator, synthesis, critic, planner"
echo -e "  ${BLUE}● Sonnet:${NC} researcher, perplexity-researcher, research-judge, claude-md-auditor, implementer"
echo -e "  ${CYAN}○ Haiku:${NC}  web-search-researcher, summarizer, test-writer, installer, validator"
echo ""
echo -e "${CYAN}Workflow Modes:${NC}"
echo -e "  📐 PLAN MODE     - Read-only exploration and planning (planner agent)"
echo -e "  🔨 IMPLEMENT MODE - Execute approved plans (implementer agent)"
echo -e "  ✅ VALIDATE MODE  - Run four-layer validation stack (validator agent)"
echo ""
